...
<Image 
    ...
    alt="ultra css home" 
    caption="I created [UltraCSS](https://ultracss.com) as a way to quickly and easily make pixel perfect mockups and graphics using a tool web developers already know: CSS."
    captionAlign="left"
    captionPosition="top"
/>
